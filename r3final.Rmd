...
simi_list_rtv <- 
  map_chr(
  subj_list, ~ 
    glue(data_dir, "/sub-", .x, "/roi_pearson_similarity/sub-", .x, "_space-T1w_task-retrieval_desc-{preproc_id}-{estimate_id}-zr_similarity.tsv")
...
labels_list <-
  map_chr(
    subj_list, ~ 
      glue(data_dir, "/sub-", .x, "/beh_labels/sub-", .x, "_labels_pairwise.tsv")
